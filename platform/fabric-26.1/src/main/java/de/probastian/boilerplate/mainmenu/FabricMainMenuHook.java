...
/**
 * Version Adapter implementing {@link MainMenuHook} for Minecraft 26.1
 * (Mojang-mapped, unobfuscated). Mirrors {@code fabric-26.2}'s adapter of
 * the same name -- 26.1 does not require a different implementation.
 *
