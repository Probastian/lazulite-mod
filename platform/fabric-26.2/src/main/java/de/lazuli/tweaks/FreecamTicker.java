 ...
 * {@code FreecamTicker} (byte-identical to {@code fabric-26.1}'s copy of
 * this file -- confirmed identical API surface via {@code javap}) -- same
 * class Javadoc rationale applies, see the 1.21.11 file (movement-key
 * routing needs no dedicated mixin: {@code
 ...
 * consumed by {@code HudFreecamHudMixin} alongside AD-7's own toggle) when
