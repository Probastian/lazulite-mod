...
public final class WorldsPanel {
    ...
    private void reloadInternal() {
        ...
        // levelStorage.loadSummaries() below spawns ForkJoinPool workers
        ...
        // fix elsewhere in this class (a still-held lock racing a reload()
        // call); the fix here is to simply not reload while a world is
        // currently loaded/loading, since this panel isn't visible during an
        // active session anyway -- the next real return-to-main-menu
