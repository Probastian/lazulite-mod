 ...
 * shape {@link SteamworksServiceHandoff} already establishes (main-menu plan
 * Risk 4 / Sequencing step 8's own first sub-step: no such hand-off existed
 * for this facade before this feature needed one, so this class is new).
